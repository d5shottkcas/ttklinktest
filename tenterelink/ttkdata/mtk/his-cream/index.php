...
<head>
  ...
  <title>HI's★cream  - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">HI's★cream</h1>
          <h1 class="pagetitle en" lang="en-gb">HI's★cream</h1>
          <h1 class="pagetitle tw" lang="zh-tw">HI's★cream</h1>
          <h1 class="pagetitle tl" lang="tl-ph">HI's★cream</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
          ...
          <h2 class="h2-border text-left">HI's★cream</h2>

       <p class="text-left small">※表は左右にスクロールできます。</p>
       
          <table class="table table-bordered table-responsive text-nowrap mx-auto prof-n" summary="Dream5">

<tr>
<th class="prof-h w200">名　前</th>
<th class="prof-h w150">担当</th>
<th class="prof-h w70">学　年</th>
<th class="prof-h w150">誕生日</th>
<th class="prof-h w280">所属事務所（出身）</th>
</tr>

            <?php
            $lines = file('csv/his-cream.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            $csv = explode(',',$lines[$i]);
            echo '<tr>';
            echo $csv[0].$csv[1].$csv[2];
            echo '</th>'.'<td class="text-center">';
            echo $csv[3];
          ...
          <p class="size2 text-left">※2010年度時</p>

                    <h2 class="h2-border text-left">MTK</h2>

<table class="table table-bordered table-responsive text-nowrap mx-auto bace" summary="Dream5">

<tr>
<th class="th-i text-center">MTK番号</th>
<th class="th-i text-center">放送日</th>
<th class="th-i text-center">曲名</th>
</tr>

  <?php
  $lines = file('csv/his-cream-mtk.csv');
  $count = count($lines);
  for($i=0;$i<$count;$i++){
  $csv = explode(',',$lines[$i]);
  ...
  ?>
      ...
      <div class="col-lg-3 order-lg-1">
        ...
        <h3 class="h2-border">ユニット一覧</h3>

        <div class="smenu">
          <ul class="smenu">

            <?php
            $lines = file('../csv/unit-list.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
