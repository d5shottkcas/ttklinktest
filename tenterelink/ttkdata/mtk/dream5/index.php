...
<head>
  ...
  <title>Dream5 ドリーム5  - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">Dream5</h1>
          <h1 class="pagetitle en" lang="en-gb">Dream5</h1>
          <h1 class="pagetitle tw" lang="zh-tw">Dream5</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Dream5</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
          ...
          <h2 class="h2-border text-left">Dream5</h2>
...
<th class="prof-h w280">所属事務所（出身）</th>
          ...
          <p class="size2 text-left">※2009年度時</p>
