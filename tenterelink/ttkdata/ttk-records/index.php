  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれレコード</h1>
          <h1 class="pagetitle en" lang="en-gb">TTK RECORDS</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれレコード</h1>
          <h1 class="pagetitle tl" lang="tl-ph">TTK RECORDS</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h2 class="h2-border text-left jp" lang="ja-jp">天てれレコード</h2>
        <h2 class="h2-border text-left en" lang="en-gb">TTK RECORDS</h2>
        <h2 class="h2-border text-left tw" lang="zh-tw">天てれレコード</h2>
        <h2 class="h2-border text-left tl" lang="tl-ph">TTK RECORDS</h2>

<p class="text-left small">天てれにおけるいろいろな記録を刻んでいます。こじつけもありますが。</p>

        <p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-event table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="天てれレコード">

          <?php
                $lines = file('csv/ttk-records.csv');
                $count = count($lines);
                for($i=0;$i<$count;$i++){
                $csv = explode(',',$lines[$i]);
                echo '<tr>';
                echo '<th class="th-i text-left">'.$csv[0].'</th>';
                echo '</tr>';
                echo '<tr>';
        ...
        <h2 class="h2-border text-left jp" lang="ja-jp">天てれオンリーワン</h2>
        <h2 class="h2-border text-left en" lang="en-gb">TTK ONLY ONE</h2>
        <h2 class="h2-border text-left tw" lang="zh-tw">天てれオンリーワン</h2>
        <h2 class="h2-border text-left tl" lang="tl-ph">TTK ONLY ONE</h2>

<p class="text-left small">天てれにおけるオンリーワンを刻んでいます。</p>
