...
<head>
  ...
  <title>天てれオリジナルユニット - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれオリジナルユニット</h1>
          <h1 class="pagetitle en" lang="en-gb">Original Unit</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれオリジナルユニット</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Original Unit</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h2 class="h2-border text-left jp" lang="ja-jp">天てれオリジナルユニット一覧</h2>
        <h2 class="h2-border text-left en" lang="en-gb">Original Unit List</h2>
        <h2 class="h2-border text-left tw" lang="zh-tw">天てれオリジナルユニット一覧</h2>
        <h2 class="h2-border text-left tl" lang="tl-ph">Original Unit List</h2>

<p class="text-left small">天てれ内で作られたオリジナルユニット・グループなどの一覧です。<br>
１回きりのものなど、結構細かいのも載せてます。基本的に視聴者に参加したチームは入っていません(一部除く)。<br>
グループ名があるものだけ掲載しています。五十音順です。</p>
        ...
        <table class="table table-bordered-event table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="天てれオリジナルユニット">
          ...
          <tr>
            <th class="th-i">ユニット名</th>
            <th class="th-i">メンバー</th>
            <th class="th-i">登場年度</th>
            <th class="th-i">備考（歌ったMTK、登場コーナーなど）</th>
          </tr>

          <?php
                $lines = file('csv/ttk-unit.csv');
                $count = count($lines);
                for($i=0;$i<$count;$i++){
                $csv = explode(',',$lines[$i]);
                echo '<tr>';
                ...
                echo '<td>'.$csv[2].'</td>';
                echo '<td class="text-left">'.$csv[3].'</td>';
                echo '</tr>';
                }
                ?>
