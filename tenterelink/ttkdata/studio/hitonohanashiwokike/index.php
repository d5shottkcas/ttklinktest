...
<head>
  ...
  <title>人の話を聞け 一覧 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">人の話を聞け 一覧</h1>
          <h1 class="pagetitle en" lang="en-gb">人の話を聞け 一覧</h1>
          <h1 class="pagetitle tw" lang="zh-tw">人の話を聞け 一覧</h1>
          <h1 class="pagetitle tl" lang="tl-ph">人の話を聞け 一覧</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border text-left">人の話を聞け (2011, 2012, 2013)</h3>

<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="人の話を聞け">
          ...
          <tr>
            ...
            <th class="th-i">ゲスト</th>
            <th class="th-i">質問者</th>
          </tr>

          <?php
                $lines = file('csv/hitonohanashiwokike2011.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <?php
                $lines = file('csv/hitonohanashiwokike2012.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <?php
                $lines = file('csv/hitonohanashiwokike2013.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
