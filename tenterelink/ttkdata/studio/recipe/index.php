...
<head>
  ...
  <title>給食には出ない秘密レシピ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">給食には出ない秘密レシピ</h1>
          <h1 class="pagetitle en" lang="en-gb">給食には出ない秘密レシピ</h1>
          <h1 class="pagetitle tw" lang="zh-tw">給食には出ない秘密レシピ</h1>
          <h1 class="pagetitle tl" lang="tl-ph">給食には出ない秘密レシピ</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
                ...
                <h2 class="h2-border text-left">給食には出ない秘密レシピ 2010年度</h2>

                <p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="給食には出ない秘密レシピ">
