...
<head>
  ...
  <title>ラフィン★スター - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">SF (?)スペース新喜劇 ラフィン★スター</h1>
          <h1 class="pagetitle en" lang="en-gb">SF Space Comedy "Rafin Star"</h1>
          <h1 class="pagetitle tw" lang="zh-tw">SF (?)宇宙新喜劇 ラフィン★スター</h1>
          <h1 class="pagetitle tl" lang="tl-ph">SF Space Comedy "Rafin Star"</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border">ラフィン★スター (2002)</h3>

          <p class="text-left">2002年度に放送されたドラマ</p>
          ...
          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="ラフィン★スター">
            ...
            <tr>
              <th class="th-i text-center">キャスト</th>
              <th class="th-i text-center">ゲスト</th>
            </tr>

                        <?php
            $lines = file('csv/rafinstar-cast.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="ラフィン★スター">
                        ...
                        <tr>
              <th colspan="3" class="th-white text-left"></th>
            </tr>

            <tr>
              <th class="th-i text-center">話数</th>
              <th class="th-i text-center">放送日</th>
              <th class="th-i text-center">サブタイトル</th>
            </tr>

            <?php
            $lines = file('csv/rafinstar-list.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
