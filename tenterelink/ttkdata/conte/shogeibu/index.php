...
<head>
  ...
  <title>こちらHK学園笑芸部！ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">こちらHK学園笑芸部！</h1>
          <h1 class="pagetitle en" lang="en-gb">こちらHK学園笑芸部！</h1>
          <h1 class="pagetitle tw" lang="zh-tw">こちらHK学園笑芸部！</h1>
          <h1 class="pagetitle tl" lang="tl-ph">こちらHK学園笑芸部！</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border">こちらHK学園笑芸部！ (2003年度)</h3>

                  <p class="text-left">2003年度に放送されたドラマ</p>

<p class="text-left small">※表は左右にスクロールできます。</p>

          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="ラフィン★スター">

<tr>
  <th class="th-i text-center">笑芸部</th>
  <th class="th-i text-center">生徒会</th>
</tr>

            <?php
$lines = file('csv/shogeibu-cast.csv');
$count = count($lines);
for($i=0;$i<$count;$i++){
...
<h3 class="h2-border">放映リスト</h3>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="こちらHK学園笑芸部！">

          <tr>
            <th class="th-i text-center">回</th>
            <th class="th-i text-center">タイトル</th>
            <th class="th-i text-center">放送日</th>
          </tr>

          <?php
                $lines = file('csv/shogeibu.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
