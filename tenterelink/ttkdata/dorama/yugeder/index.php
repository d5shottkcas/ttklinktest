  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ユゲデール物語</h1>
          <h1 class="pagetitle en" lang="en-gb">ユゲデール物語</h1>
          <h1 class="pagetitle tw" lang="zh-tw">ユゲデール物語</h1>
          <h1 class="pagetitle tl" lang="tl-ph">ユゲデール物語</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border text-left">ユゲデール物語 (2005, 2006)</h3>

        <p class="text-left">2005年度、2006年度に放送されたコーナードラマ。</p>

<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="ユゲデール物語">
	<tr>
            <th colspan="5" class="th-white text-left">ユゲデール物語　(2005年度)</th>
	</tr>
          ...
          <?php
                $lines = file('csv/yugeder2005.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
                ...
                ?>
	<tr>
            <th colspan="5" class="th-white text-left">新ユゲデール物語　(2006年度)</th>
	</tr>
          ...
          <?php
                $lines = file('csv/yugeder2006.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
