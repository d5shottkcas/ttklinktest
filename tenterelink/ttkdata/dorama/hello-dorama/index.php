...
<head>
  ...
  <title>天才てれびくんhello&#44; ドラマ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天才てれびくんhello&#44;ドラマ</h1>
          <h1 class="pagetitle en" lang="en-gb">Whiz-Kids TV hello&#44;'s Drama</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天才てれびくんhello&#44;ドラマ</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Tensai　Terebikun hello&#44;'s Drama</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border text-left">天才てれびくんhello&#44; ドラマ</h3>

        <p class="text-left">2020、2021年度に放送されたドラマ。</p>

<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="天才てれびくんhello,ドラマ">
	<tr>
          ...
          <?php
                $lines = file('csv/hello-dorama2020.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
...
<tr>
            <th colspan="4" class="th-white text-left">2021年度</th>
	</tr>
          ...
          <?php
                $lines = file('csv/hello-dorama2021.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
