...
<head>
  ...
  <title>日付変更船プッカリーノ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">日付変更船プッカリーノ</h1>
          <h1 class="pagetitle en" lang="en-gb">日付変更船プッカリーノ</h1>
          <h1 class="pagetitle tw" lang="zh-tw">日付変更船プッカリーノ</h1>
          <h1 class="pagetitle tl" lang="tl-ph">日付変更船プッカリーノ</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h2 class="h2-border text-left">日付変更船プッカリーノ(2008年度)</h2>

                <p class="text-left">2008年度に放送されたコーナードラマ。</p>

<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="日付変更船プッカリーノ">
