  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">念力家族</h1>
          <h1 class="pagetitle en" lang="en-gb">念力家族</h1>
          <h1 class="pagetitle tw" lang="zh-tw">念力家族</h1>
          <h1 class="pagetitle tl" lang="tl-ph">念力家族</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border text-left">念力家族 (2015, 2016)</h3>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="念力家族">

          <tr>
            <th colspan="5" class="th-white text-left">2015年度</th>
          </tr>

          <tr>
            <th class="th-i">話数</th>
            <th class="th-i">放送日</th>
            <th class="th-i">サブタイトル</th>
            <th class="th-i">脚本</th>
            <th class="th-i">ゲスト</th>
          </tr>

          <?php
                $lines = file('csv/nenrikikazoku2015.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <tr>
            <th colspan="5" class="th-white text-left">2016年度</th>
          </tr>
          ...
          <?php
                $lines = file('csv/nenrikikazoku2016.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
