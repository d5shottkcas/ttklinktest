  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">大迷宮冒険記</h1>
          <h1 class="pagetitle en" lang="en-gb">大迷宮冒険記</h1>
          <h1 class="pagetitle tw" lang="zh-tw">大迷宮冒険記</h1>
          <h1 class="pagetitle tl" lang="tl-ph">大迷宮冒険記</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h2 class="h2-border text-left">大迷宮冒険記 (2007年度)</h2>

        <p class="text-left">2007年度に放送されたコーナードラマ。</p>

<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="大迷宮冒険記">

          <tr>
            <th class="th-i">回</th>
            <th class="th-i">タイトル</th>
            <th class="th-i">放送日</th>
            <th class="th-i">【ユート（Uto)】</th>
            <th class="th-i">【レッツ（Let's）】</th>
            <th class="th-i">【その他】</th>
            <th class="th-i">脚本</th>
          </tr>

          <?php
                $lines = file('csv/daimeikyu.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
