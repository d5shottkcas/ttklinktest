...
<head>
  ...
  <title>天ドラ 天てれドラマ（MAX時代） - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれドラマ (2005 - 2010)</h1>
          <h1 class="pagetitle en" lang="en-gb">Dorama (2005 - 2010)</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれドラマ (2005 - 2010)</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Dorama (2005 - 2010)</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border">天ドラ（MAX時代）</h3>

<p>てれび戦士が不思議な出来事にまきこまれる･･･。</p>
<p>2005年度以降「天てれドラマ」内で放送されたドラマです。<br>
番号は当サイトで勝手に振っているだけで、正式に振られているのかは分かりません。<br>
2005年度「ユゲデール物語」は『天てれドラマ』の括りの中で放送されたものなので一応入れてあります。<br>
2009年度「ミラクルシャッター」も同様です。</p>
          <p class="text-left small">※表は左右にスクロールできます。</p>

          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="2002年度放送一覧">

            <tr>
              <th colspan="4" class="th-white text-left">2005年度</th>
            </tr>

            <tr>
              <th class="th-i text-center">No.</th>
              <th class="th-i text-center">題名</th>
              <th class="th-i text-left">出演</th>
            </tr>

            <?php
            $lines = file('csv/tendora2005.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            <tr>
              <th colspan="4" class="th-white text-left">2006年度</th>
            </tr>
            ...
            <?php
            $lines = file('csv/tendora2006.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            ?>
                        ...
                        <tr>
              <th colspan="4" class="th-white text-left">2007年度</th>
            </tr>
            ...
            <?php
            $lines = file('csv/tendora2007.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            ?>
                                    ...
                                    <tr>
              <th colspan="4" class="th-white text-left">2008年度</th>
            </tr>
            ...
            <?php
            $lines = file('csv/tendora2008.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
           ...
           <tr>
              <th colspan="4" class="th-white text-left">2009年度</th>
            </tr>
            ...
            <?php
            $lines = file('csv/tendora2009.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            ?>
                       ...
                       <tr>
              <th colspan="4" class="th-white text-left">2010年度</th>
            </tr>
            ...
            <?php
            $lines = file('csv/tendora2010.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
