...
<head>
  ...
  <title>魔界探偵、魔界同盟 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">魔界探偵、魔界同盟</h1>
          <h1 class="pagetitle en" lang="en-gb">Demon world</h1>
          <h1 class="pagetitle tw" lang="zh-tw">魔界探偵、魔界同盟</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Makai Tantei</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h3 class="h2-border">魔界探偵、魔界同盟 (2000, 2001)</h3>
          
          <p class="text-left">2000年度、2001年度に放送されたドラマ</p>

          <p class="text-left small">※表は左右にスクロールできます。</p>

          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="魔界探偵、魔界同盟">

            <tr>
              <th colspan="4" class="th-white text-left">2000年度「魔界探偵」</th>
            </tr>

            <tr>
              <th class="th-i text-center" colspan="4">キャスト</th>
            </tr>

                        <?php
            $lines = file('csv/makai2000cast.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            ?>
                        ...
                        <tr>
              <th colspan="4" class="th-white text-left"></th>
            </tr>

            <tr>
              <th class="th-i text-center">放送回</th>
              <th class="th-i text-center">放送日</th>
              <th class="th-i text-center">サブタイトル</th>
              <th class="th-i text-center">ゲスト</th>
            </tr>

            <?php
            $lines = file('csv/makai2000list.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            <tr>
              <th colspan="4" class="th-white text-left">2001年度「魔界同盟」</th>
            </tr>
            ...
            <tr>
              <th class="th-i text-center" colspan="4">キャスト</th>
                        ...
                        <?php
            $lines = file('csv/makai2001cast.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            <?php
            $lines = file('csv/makai2001list.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
      ...
      <div class="col-lg-3 order-lg-1">
        ...
        <div class="smenu">
          <ul class="smenu">
            ...
            <?php
            $lines = file('../../csv/wide-data-2.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
