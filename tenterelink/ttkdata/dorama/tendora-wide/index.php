...
<head>
  ...
  <title>天ドラ 天てれドラマ （ワイド時代） - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれドラマ (2001, 2002)</h1>
          <h1 class="pagetitle en" lang="en-gb">Dorama (2001, 2002)</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれドラマ (2001, 2002)</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Dorama (2001, 2002)</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border">天ドラ（ワイド時代）</h3>

<p>天てれ視聴者から原案を募集し、ドラマ化する企画。<br>応募した視聴者も、ドラマの撮影にキャストとして参加する場合があった。</p>
          ...
          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="2002年度放送一覧">
            ...
            <tr>
              <th colspan="4" class="th-white text-left">2001年度</th>
            </tr>
            ...
            <?php
            $lines = file('csv/tendora2001.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            <tr>
              <th colspan="4" class="th-white text-left">2002年度</th>
            </tr>
            ...
            <?php
            $lines = file('csv/tendora2002.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
