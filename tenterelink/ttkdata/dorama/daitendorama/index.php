...
<head>
  ...
  <title>ドラマ　大！天才テレビジョン - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ドラマ　大！天才テレビジョン</h1>
          <h1 class="pagetitle en" lang="en-gb">ドラマ　大！天才テレビジョン</h1>
          <h1 class="pagetitle tw" lang="zh-tw">ドラマ　大！天才テレビジョン</h1>
          <h1 class="pagetitle tl" lang="tl-ph">ドラマ　大！天才テレビジョン</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border text-left">大！天才テレビジョン (2011, 2012, 2013)</h3>

<p class="text-left">2011年度、2012年度、2013年度に放送されたコーナードラマ。</p>
<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="大！天才テレビジョン">

          <tr>
            <th colspan="3" class="th-white text-left">2011年度</th>
          </tr>
          <tr>
            <th class="th-i">回</th>
            <th class="th-i">連動企画</th>
            <th class="th-i">放送日</th>
          </tr>

          <?php
                $lines = file('csv/daitendorama2011-01.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <tr>
            <th colspan="3" class="th-white text-left">大天才テレビジョン第2次計画　(11年後期)</th>
          </tr>

          <?php
                $lines = file('csv/daitendorama2011-02.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <tr>
            <th colspan="3" class="th-white text-left">2012年度</th>
          </tr>
          ...
          <?php
                $lines = file('csv/daitendorama2012.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <tr>
            <th colspan="3" class="th-white text-left">2013年度</th>
          </tr>
          ...
          <?php
                $lines = file('csv/daitendorama2013.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
