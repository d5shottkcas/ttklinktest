  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">東京特許許可局</h1>
          <h1 class="pagetitle en" lang="en-gb">東京特許許可局</h1>
          <h1 class="pagetitle tw" lang="zh-tw">東京特許許可局</h1>
          <h1 class="pagetitle tl" lang="tl-ph">東京特許許可局</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border text-left">東京特許許可局 (2014)</h3>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="東京特許許可局">

          <tr>
            <th class="th-i">話数</th>
            <th class="th-i">放送回</th>
          ...
          <?php
                $lines = file('csv/toukyoutokkyokyokakyoku.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
