...
<body onload="scrollTest()">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          ...
          <h1 class="pagetitle en" lang="en-gb">DENRIKI</h1>
          <h1 class="pagetitle tw" lang="zh-tw">電力一覧表</h1>
          <h1 class="pagetitle tl" lang="tl-ph">DENRIKI</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="デンリキ一覧">
            ...
            <tr>
              <th colspan="3" class="th-white text-left">ドラマ</th>
            </tr>
            ...
            <?php
            $lines = file('csv/dennriki-2020.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
      ...
      <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="デンリキ一覧">
      <tr>
              <th colspan="3" class="th-white text-left">木生</th>
            </tr>
      ...
      <tr>
            ...
            <?php
            $lines = file('csv/dennriki-mokunama.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
