  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれ部活動一覧表</h1>
          <h1 class="pagetitle en" lang="en-gb">天てれ部活動一覧表</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれ部活動一覧表</h1>
          <h1 class="pagetitle tl" lang="tl-ph">天てれ部活動一覧表</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border text-left">天てれ部活動</h3>

<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="天てれ部活動">

          <tr>
            <th colspan="3" class="th-white text-left">2006年度</th>
          </tr>

          <tr>
            <th class="th-i">部活動</th>
            <th class="th-i">コーチ</th>
            <th class="th-i text-left">部員</th>
          </tr>

          <?php
                $lines = file('csv/bukatsudou2006.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <tr>
            <th colspan="3" class="th-white text-left">2007年度</th>
          </tr>
          ...
          <?php
                $lines = file('csv/bukatsudou2007.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <tr>
            <th colspan="3" class="th-white text-left">2008年度</th>
          </tr>
          ...
          <?php
                $lines = file('csv/bukatsudou2008.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <tr>
            <th colspan="3" class="th-white text-left">2009年度</th>
          </tr>
          ...
          <?php
                $lines = file('csv/bukatsudou2009.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <tr>
            <th colspan="3" class="th-white text-left">2010年度</th>
          </tr>
          ...
          <?php
                $lines = file('csv/bukatsudou2010.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
