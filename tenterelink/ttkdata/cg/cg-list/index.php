...
<head>
  ...
  <title>歴代天てれCGキャラクター一覧 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">歴代天てれCGキャラクター一覧表</h1>
          <h1 class="pagetitle en" lang="en-gb">CG Character List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">歴代天てれCGキャラクター一覧表</h1>
          <h1 class="pagetitle tl" lang="tl-ph">CG Character List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h3 class="h2-border">歴代天てれCGキャラクター</h3>
...
<h3 class="h2-border">CGキャラリスト</h3>

<div class="smenu">
  <ul class="smenu">

    <?php
    $lines = file('../csv/cg.csv');
    $count = count($lines);
    for($i=0;$i<$count;$i++){
