  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">モジルスーツ一覧表</h1>
          <h1 class="pagetitle en" lang="en-gb">Kanji Remodeling Suit List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">字符重塑套裝一覧表</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Kanji Remodeling Suit List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h3 class="h2-border">モジルスーツ (2019)</h3>
          ...
          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="もじ魔獣一覧">
            ...
            <?php
            $lines = file('csv/mojirusuit2019.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
