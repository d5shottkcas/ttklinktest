  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">異次元獣一覧表</h1>
          <h1 class="pagetitle en" lang="en-gb">Another dimension monster List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">異次元獣一覧表</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Ijigen-Ju List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border">異次元獣 (2014, 2015, 2016)</h3>

          <p class="text-left small">※表は左右にスクロールできます。</p>

          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="異次元獣一覧">

            <tr>
              <th colspan="4" class="th-white text-left">2014年度</th>
            </tr>

            <tr>
              <th class="th-i text-center">コア</th>
              <th class="th-i text-center">どちゃもん</th>
              <th class="th-i text-center">関係者</th>
              <th class="th-i text-center">放送日</th>
            </tr>

            <?php
            $lines = file('csv/ijigenju2014.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            <?php
            $lines = file('csv/ijigenju2015.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          ?>
            ...
            <?php
            $lines = file('csv/ijigenju2016.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
