  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">もじ魔獣一覧表</h1>
          <h1 class="pagetitle en" lang="en-gb">Kanji RabidFang List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">もじ魔獣一覧表</h1>
          <h1 class="pagetitle tl" lang="tl-ph">MoJi-MaJu List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h3 class="h2-border">もじ魔獣 (2017, 2018)</h3>

          <p class="text-left small">※表は左右にスクロールできます。</p>

          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="もじ魔獣一覧">

            <tr>
              <th colspan="5" class="th-white text-left">2017年度</th>
            </tr>

            <tr>
              <th class="th-i text-center">もじ魔獣</th>
              <th class="th-i text-center">もじもん</th>
              <th class="th-i text-center">関係者</th>
              <th class="th-i text-center">放送日</th>
              <th class="th-i text-center">特生中継先</th>
            </tr>

            <?php
            $lines = file('csv/mojimajyu2017.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            <tr>
              <th colspan="5" class="th-white text-left">2018年度</th>
            </tr>
            ...
            <?php
            $lines = file('csv/mojimajyu2018.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
