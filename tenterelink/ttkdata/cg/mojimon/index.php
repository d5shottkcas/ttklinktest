  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">もじもん一覧表</h1>
          <h1 class="pagetitle en" lang="en-gb">Kanji Monster List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">もじもん一覧表</h1>
          <h1 class="pagetitle tl" lang="tl-ph">MoJiMoN List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h3 class="h2-border">もじもん (2017, 2018, 2019)</h3>

          <p class="text-left small">※表は左右にスクロールできます。</p>

          <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace wh-bd-none small" summary="もじもん一覧">

            <tr>
              <th colspan="4" class="th-white text-left">2017年度</th>
            </tr>

            <tr>
              <th class="th-i text-center">名前</th>
              <th class="th-i text-center">漢字</th>
              <th class="th-i text-center">初登場日</th>
              <th class="th-i text-center">声優</th>
            </tr>

            <?php
            $lines = file('csv/mojimon2017.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            <tr>
              <th colspan="4" class="th-white text-left">2018年度</th>
            </tr>
            ...
            <?php
            $lines = file('csv/mojimon2018.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          ?>
                    ...
                    <tr>
           <th colspan="4" class="th-white text-left">2019年度</th>
          </tr>
            ...
            <?php
            $lines = file('csv/mojimon2019.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
