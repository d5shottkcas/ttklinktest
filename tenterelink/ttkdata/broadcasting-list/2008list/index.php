...
<head>
  ...
  <title>2008年度放送一覧 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">2008年度放送一覧</h1>
          <h1 class="pagetitle en" lang="en-gb">2008 List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">2008年度放送一覧</h1>
          <h1 class="pagetitle tl" lang="tl-ph">2008 List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2008年度放送一覧</h2>
...
<br>
ビットワールドは入っていません。</p>
<p><a href="../2008allcast">2008年度出演者リスト</a></p>

          <table class="table table-bordered mx-auto bace allcast small" summary="2008年度放送一覧">

            <?php
            $lines = file('csv/2008list.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
  ...
  <footer class="py-5 bg-orange">
    <div class="container">
      <p class="m-0 text-center text-dark">since 6.26.2001 by ichiro (since 3.25.2008 by Giabbit)
        <br> Copyright &copy; 2008 天てれリンク. All Rights Reserved. </p>
    </div>
    <!-- /.container -->
  </footer>
