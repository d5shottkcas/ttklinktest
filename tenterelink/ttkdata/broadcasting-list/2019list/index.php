...
<head>
  ...
  <title>2019年度放送一覧 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">2019年度放送一覧</h1>
          <h1 class="pagetitle en" lang="en-gb">2019 List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">2019年度放送一覧</h1>
          <h1 class="pagetitle tl" lang="tl-ph">2019 List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2019年度放送一覧</h2>

          <table class="table table-bordered mx-auto bace small" summary="2019年度放送一覧">

            <?php
            $lines = file('csv/2019list.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
