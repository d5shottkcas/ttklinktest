...
<head>
  ...
  <title>2007年度放送一覧 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">2007年度放送一覧</h1>
          <h1 class="pagetitle en" lang="en-gb">2007 List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">2007年度放送一覧</h1>
          <h1 class="pagetitle tl" lang="tl-ph">2007 List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2007年度放送一覧</h2>

          <p class="small">MTKはエンディングMTKです。出演者に関しては、MTKや再放送など、２回目以降の放送は除いてあります。<br>
生放送の出演メンバーは、スタジオメンバーが進行するコーナーは抜いてあります（ロケは入れてあります）。<br>
ピンク色は再放送コーナーです(MTKは再放送扱いしていません)。もうちょっと詳しい内容は、<a href="https://ameblo.jp/tenterelink/">天てれ視聴日記</a>に書いてあります。<br>
<br>
ビットワールドは入っていません。</p>
<p><a href="../2007allcast">2007年度出演者リスト</a></p>

          <table class="table table-bordered mx-auto bace allcast small" summary="2007年度放送一覧">

            <?php
            $lines = file('csv/2007list.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            echo $csv[0];
            echo '</td>'.'<td class="w-75 allcast-bgffff99">';
            echo $csv[1];
            echo '</td>'.'</tr>';
            }
            ?>
  ...
  <footer class="py-5 bg-orange">
    <div class="container">
      <p class="m-0 text-center text-dark">since 6.26.2001 by ichiro (since 3.25.2007 by Giabbit)
        <br> Copyright &copy; 2007 天てれリンク. All Rights Reserved. </p>
    </div>
    <!-- /.container -->
  </footer>
