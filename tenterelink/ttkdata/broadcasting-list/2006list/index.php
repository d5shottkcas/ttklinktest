...
<head>
  ...
  <title>2006年度放送一覧 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">2006年度放送一覧</h1>
          <h1 class="pagetitle en" lang="en-gb">2006 List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">2006年度放送一覧</h1>
          <h1 class="pagetitle tl" lang="tl-ph">2006 List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2006年度放送一覧</h2>

          <p class="font-weight-bold small">
          MTKはエンディングMTKです。またスペースの都合で再放送の枠に入ってる場合もあります。<br>
イラスト紹介はスペースの都合で再放送の枠に入っていても、全部新作です。</p>

          <table class="table table-bordered mx-auto bace allcast small" summary="2006年度放送一覧">

            <?php
            $lines = file('csv/2006list.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
            ...
            ?>
                    ...
                    <p><a href="../2006allcast">2006年度出演者リスト</a></p>
  ...
  <footer class="py-5 bg-orange">
    <div class="container">
      <p class="m-0 text-center text-dark">since 6.26.2001 by ichiro (since 3.25.2006 by Giabbit)
        <br> Copyright &copy; 2006 天てれリンク. All Rights Reserved. </p>
    </div>
    <!-- /.container -->
  </footer>
