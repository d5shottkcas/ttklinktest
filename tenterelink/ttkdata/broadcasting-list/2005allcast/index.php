...
<head>
  ...
  <title>2005年度出演者リスト - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">2005年度出演者リスト</h1>
          <h1 class="pagetitle en" lang="en-gb">2005 All Cast List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">2005年度出演者リスト</h1>
          <h1 class="pagetitle tl" lang="tl-ph">2005 All Cast List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2005年度出演者</h2>

          <p>
てれび戦士の全出演リストです。<br>
ＭＴＫとエンディングは初回放送のみ。再放送は含まない（１部のぞく）。<br>
少しの出演だけでもはっきりとした出番があれば入ってます。<br>
（SK）がついているものは＜スチームナイツのとりで＞、<br>
（JM）のついているものは＜ジョーキマホーンズのアジト＞で行った企画です。<br>
木曜生放送やドラマは、過去の天てれ２００５年度にさらに詳しく載ってます。<br>
</p>

          <table class="table table-bordered table-responsive text-nowrap mx-auto small" summary="2005年度出演者">

            <tr>
              <td rowspan="2" class="allcast-bgffcc00 text-center">放送日</td>
              <td rowspan="2" class="allcast-bgffcc00 text-center">コーナー</td>
              <td colspan="11" class="allcast-bg-red text-center text-white">レインボーガーディアンズ</td>
              <td colspan="11" class="allcast-bg-green text-center text-white">アンダーワールドファミリー</td>
            </tr>

            <tr>
              <td class="allcast-bgffff00">飯<br>
      田<br>
      里<br>
      穂
              </td>
              <td class="allcast-bgffff00">前<br>
      田<br>
      公<br>
      輝
              </td>
      ...
      気
              ...
              <td class="allcast-bgffff00">篠<br>
      原<br>
      愛<br>
      実
              </td>
              <td class="allcast-bgffff00">髙<br>
      橋<br>
      郁<br>
      哉
              </td>
              <td class="allcast-bgffff00">木<br>
      内<br>
      江<br>
      莉
              </td>
              <td class="allcast-bgffff00">近<br>
      藤<br>
      エ<br>
      マ
              </td>
      ...
      希
              ...
              <td class="allcast-bgffff00">藤<br>
      本<br>
      七<br>
      海
              </td>
      ...
      ン
              ...
              <td class="allcast-bgffff00">村<br>
      田<br>
      ち<br>
      ひ<br>
      ろ
              ...
              <td class="allcast-bgffff00">洸<br>
      太<br>
      レ<br>
      イ<br>
      シ<br>
      ｜
              ...
              <td class="allcast-bgffff00">橋<br>
      本<br>
      甜<br>
      歌
              </td>
              <td class="allcast-bgffff00">伊<br>
      倉<br>
      愛<br>
      美
              </td>
              <td class="allcast-bgffff00">永<br>
      島<br>
      謙<br>
      二<br>
      郎
              </td>
              <td class="allcast-bgffff00">千<br>
      秋<br>
      レ<br>
      イ<br>
      シ<br>
      ｜
              ...
              <td class="allcast-bgffff00">一<br>
      木<br>
      有<br>
      海
              </td>
      ...
      奈
              ...
              <td class="allcast-bgffff00">川<br>
      﨑<br>
      樹<br>
      音
              </td>
              <td class="allcast-bgffff00">笠<br>
      原<br>
      拓<br>
      巳
              </td>
            ...
            $lines = file('csv/2005allcast.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
      ...
      巳
          ...
          <p><a href="../2005list">2005年度放送一覧</a></p>
