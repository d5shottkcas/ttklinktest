...
<head>
  ...
  <title>2004年度出演者リスト - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">2004年度出演者リスト</h1>
          <h1 class="pagetitle en" lang="en-gb">2004 All Cast List</h1>
          <h1 class="pagetitle tw" lang="zh-tw">2004年度出演者リスト</h1>
          <h1 class="pagetitle tl" lang="tl-ph">2004 All Cast List</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2004年度出演者</h2>

          <p>
てれび戦士の全出演リストです。<br>
ＭＴＫとエンディングは初回放送のみ。再放送は含まない（１部のぞく）。<br>
勝手議会や木生やＭＴＫでは、少しの出演だけでもはっきりとした出番があれば入ってます。<br>
ゲームゾーンや木曜生放送やドラマは、過去の天てれ２００４年度にさらに詳しく載ってます。<br>
</p>

          <table class="table table-bordered table-responsive text-nowrap small" summary="2004年度出演者">

            <tr>
              <td rowspan="2" class="allcast-bgffcc00 text-center">放送日</td>
              <td rowspan="2" class="allcast-bgffcc00 text-center">コーナー</td>
              <td colspan="10" class="allcast-bg-red text-center text-white">レインボーガーディアンズ</td>
              <td colspan="10" class="allcast-bg-green text-center text-white">アンダーワールドファミリー</td>
            </tr>

            <tr>
              <td class="allcast-bgffff00">井<br> 出
                <br> 卓
                <br> 也
              </td>
              <td class="allcast-bgffff00">白<br> 木
                <br> 杏
                <br> 奈
              </td>
              <td class="allcast-bgffff00">村<br> 田
                <br> ち
                <br> ひ
                <br> ろ
              </td>
              <td class="allcast-bgffff00">前<br> 田
                <br> 公
                <br> 輝
              </td>
              <td class="allcast-bgffff00">ジ<br> ョ
                <br> ア
                <br> ン
              </td>
              <td class="allcast-bgffff00">バ<br> ｜
                <br> ン
                <br> ズ
                <br> 勇
                <br> 気
              </td>
              <td class="allcast-bgffff00">橋<br> 本
                <br> 甜
                <br> 歌
              </td>
              <td class="allcast-bgffff00">浅<br> 野
                <br> 優
                <br> 梨
                <br> 愛
              </td>
              <td class="allcast-bgffff00">千<br> 秋
                <br> レ
                <br> イ
                <br> シ
                <br> ｜
              </td>
              <td class="allcast-bgffff00">川<br> 﨑
                <br> 樹
                <br> 音
              </td>
              <td class="allcast-bgffff00">堀<br> 江
                <br> 幸
                <br> 生
              </td>
              <td class="allcast-bgffff00">飯<br> 田
                <br> 里
                <br> 穂
              </td>
              <td class="allcast-bgffff00">望</td>
              <td class="allcast-bgffff00">中<br> 村
                <br> 有
                <br> 沙
              </td>
              <td class="allcast-bgffff00">洸<br> 太
                <br> レ
                <br> イ
                <br> シ
                <br> ｜
              </td>
              <td class="allcast-bgffff00">篠<br> 原
                <br> 愛
                <br> 実
              </td>
              <td class="allcast-bgffff00">髙<br> 橋
                <br> 郁
                <br> 哉
              </td>
              <td class="allcast-bgffff00">伊<br> 倉
                <br> 愛
                <br> 美
              </td>
              <td class="allcast-bgffff00">近<br> 藤
                <br> エ
                <br> マ
              </td>
              <td class="allcast-bgffff00">張<br> 沢
                <br> 紫
                <br> 星
              </td>
            </tr>
            ...
            $lines = file('csv/2004allcast.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <p><a href="../2004list">2004年度放送一覧</a></p>
