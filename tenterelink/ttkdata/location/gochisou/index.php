...
<head>
  ...
  <title>ごちそう on the EARTH - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ごちそう on the EARTH</h1>
          <h1 class="pagetitle en" lang="en-gb">ごちそう on the EARTH</h1>
          <h1 class="pagetitle tw" lang="zh-tw">ごちそう on the EARTH</h1>
          <h1 class="pagetitle tl" lang="tl-ph">ごちそう on the EARTH</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h2 class="h2-border text-left">ごちそう on the EARTH 2011年度</h2>

        <p class="text-left">2011年度に放送されたコーナー。<br>世界各国の料理を寺田朱里とファデン咲美亜が紹介し、実際に作るコーナー。</p>

<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="ごちそう on the EARTH">

          <tr>
            <th colspan="5" class="th-white text-left">放映リスト</th>
          </tr>
          <tr>
            <th class="th-i">回</th>
            ...
            <th class="th-i">国</th>
            <th class="th-i">料理</th>
            <th class="th-i">出演てれび戦士</th>
          </tr>

          <?php
                $lines = file('csv/gochisou.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
