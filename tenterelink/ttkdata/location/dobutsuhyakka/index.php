...
<head>
  ...
  <title>どうぶつ飼いたい百科 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">どうぶつ飼いたい百科 一覧</h1>
          <h1 class="pagetitle en" lang="en-gb">どうぶつ飼いたい百科 一覧</h1>
          <h1 class="pagetitle tw" lang="zh-tw">どうぶつ飼いたい百科 一覧</h1>
          <h1 class="pagetitle tl" lang="tl-ph">どうぶつ飼いたい百科 一覧</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h2 class="h2-border text-left">どうぶつ飼いたい百科 2011年度</h2>

<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="どうぶつ飼いたい百科">

          <tr>
            <th class="th-i text-center">動物</th>
            <th class="th-i text-center">てれび戦士</th>
            <th class="th-i text-center">メモ</th>
            <th class="th-i text-center">放送日</th>
          </tr>

          <?php
                $lines = file('csv/dobutsuhyakka.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
                  ...
                  echo '<td>'.$csv[0].'</td>';
                  echo '<td>'.$csv[1].'</td>';
                  echo '<td class="text-left">'.$csv[2].'</td>';
                  echo '<td>'.$csv[3].'</td>';
                  echo '</tr>';
                }
                ?>
