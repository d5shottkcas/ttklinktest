  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">乗りすけさん 一覧</h1>
          <h1 class="pagetitle en" lang="en-gb">乗りすけさん 一覧</h1>
          <h1 class="pagetitle tw" lang="zh-tw">乗りすけさん 一覧</h1>
          <h1 class="pagetitle tl" lang="tl-ph">乗りすけさん 一覧</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border text-left">乗りすけさん (2011, 2012, 2013)</h3>

<p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="乗りすけさん">

          <tr>
            <th colspan="4" class="th-white text-left">2011年度</th>
          </tr>
          <tr>
            <th class="th-i">番号</th>
            <th class="th-i">乗り物</th>
            <th class="th-i">放送日</th>
            <th class="th-i">てれび戦士</th>
          </tr>

          <?php
                $lines = file('csv/norisukesan2011.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
          ...
          <tr>
            <th colspan="4" class="th-white text-left">2012年度</th>
          </tr>
          <tr>
            <th class="th-i">番号</th>
            <th class="th-i">乗り物</th>
          ...
          <?php
                $lines = file('csv/norisukesan2012.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
                ...
                ?>
          <tr>
            <th colspan="4" class="th-white text-left">2013年度</th>
          </tr>
          <tr>
            <th class="th-i">番号</th>
            <th class="th-i">乗り物</th>
          ...
          <?php
                $lines = file('csv/norisukesan2013.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
