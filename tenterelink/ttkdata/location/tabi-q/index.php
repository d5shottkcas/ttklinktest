...
<head>
  ...
  <title>天てれツアー旅っQ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれツアー旅っQ</h1>
          <h1 class="pagetitle en" lang="en-gb">天てれツアー旅っQ</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれツアー旅っQ</h1>
          <h1 class="pagetitle tl" lang="tl-ph">天てれツアー旅っQ</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
        ...
        <h3 class="h2-border text-left">天てれツアー旅っQ (2007, 2008)</h3>

        <p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="天てれツアー旅っQ">
