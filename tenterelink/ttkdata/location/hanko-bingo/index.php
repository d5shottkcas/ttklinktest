...
<head>
  ...
  <title>日本全国ハンコビンゴの旅 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">日本全国ハンコビンゴの旅</h1>
          <h1 class="pagetitle en" lang="en-gb">日本全国ハンコビンゴの旅</h1>
          <h1 class="pagetitle tw" lang="zh-tw">日本全国ハンコビンゴの旅</h1>
          <h1 class="pagetitle tl" lang="tl-ph">日本全国ハンコビンゴの旅</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-9 order-lg-2">
                ...
                <h2 class="h2-border text-left">日本全国ハンコビンゴの旅 2010年度</h2>

                <p class="text-left small">※表は左右にスクロールできます。</p>

        <table class="table table-bordered-cg table-responsive text-nowrap mx-auto bace text-555555 wh-bd-none small" summary="日本全国ハンコビンゴの旅">


          <tr>
            <th class="th-i text-center">場所</th>
            <th class="th-i text-center">名字の漢字</th>
            <th class="th-i text-center">出演てれび戦士</th>
            <th class="th-i text-center">放送日</th>
          </tr>

          <?php
                $lines = file('csv/hanko-bingo.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
