...
<head>
  ...
  <title>ブレーカーズ - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ブレーカーズ</h1>
          <h1 class="pagetitle en" lang="en-gb">Breakers</h1>
          <h1 class="pagetitle tw" lang="zh-tw">破壊者達</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Breakers</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">車いすバスケットボール編(2019)</h2>

          <table class="table table-bordered mx-auto anime" summary="ブレーカーズ">

            <?php
  $lines = file('../csv/breakers-wheelchairbasketball.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){

    $csv = explode(',',$lines[$i]);
    echo '<tr>'.'<td class="text-center w-25">';
    echo $csv[0];
    echo '</td>'.'<td class="w-75">';
    echo $csv[1];
    echo '</td>'.'</tr>';
  }
  ?>
          ...
          <h2 class="h2-border">走り高跳び編(2019)</h2>

          <table class="table table-bordered mx-auto anime" summary="ブレーカーズ">

<?php
$lines = file('../csv/breakers-highjump.csv');
$count = count($lines);
for($i=0;$i<$count;$i++){
...
　　　　　　<h2 class="h2-border">ゴールボール編(2020)</h2>

          <table class="table table-bordered mx-auto anime" summary="ブレーカーズ">

<?php
$lines = file('../csv/breakers-goalball.csv');
$count = count($lines);
for($i=0;$i<$count;$i++){
...
　　　　　　<h2 class="h2-border">パラ水泳編(2020)</h2>

          <table class="table table-bordered mx-auto anime" summary="ブレーカーズ">

<?php
$lines = file('../csv/breakers-paraswimming.csv');
$count = count($lines);
for($i=0;$i<$count;$i++){
