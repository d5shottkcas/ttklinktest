...
<head>
  ...
  <title>少年アシベ GO! GO! ゴマちゃん - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">少年アシベ GO! GO! ゴマちゃん</h1>
          <h1 class="pagetitle en" lang="en-gb">Shonen Ashibe GO! GO! Goma-chan</h1>
          <h1 class="pagetitle tw" lang="zh-tw">少年的アシベ GO! GO! ゴマちゃん</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Shonen Ashibe GO! GO! Goma-chan</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2016-2019</h2>

          <table class="table table-bordered mx-auto anime" summary="少年アシベ GO! GO! ゴマちゃん">

            <?php
  $lines = file('../csv/shonen-ashibe.csv');
  for($i=0;$i<count($lines);$i++){
