...
<head>
  ...
  <title>宇宙なんちゃら こてつくん - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">宇宙なんちゃら こてつくん</h1>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2021</h2>

          <table class="table table-bordered mx-auto anime" summary="宇宙なんちゃら こてつくん">

            <?php
  $lines = file('../csv/uchuunannchara-kotetsukunn.csv');
  for($i=0;$i<count($lines);$i++){
