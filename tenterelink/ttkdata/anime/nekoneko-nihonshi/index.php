...
<head>
  ...
  <title>ねこねこ日本史 - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ねこねこ日本史</h1>
          <h1 class="pagetitle en" lang="en-gb">Japanese history of  cats</h1>
          <h1 class="pagetitle tw" lang="zh-tw">貓的日本歷史</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Neko Neko Nihon-shi</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2016-2020</h2>

          <table class="table table-bordered mx-auto anime" summary="ねこねこ日本史">

            <?php
  $lines = file('../csv/nekoneko-nihonshi.csv');
  for($i=0;$i<count($lines);$i++){
