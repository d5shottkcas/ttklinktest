...
<head>
  ...
  <title>ジーンダイバー - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ジーンダイバー</h1>
          <h1 class="pagetitle en" lang="en-gb">Gene Diver</h1>
          <h1 class="pagetitle tw" lang="zh-tw">ジーンダイバー</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Gene Diver</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">1994</h2>

          <table class="table table-bordered mx-auto anime" summary="ジーンダイバー">

            <?php
  $lines = file('../csv/genediver.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){
