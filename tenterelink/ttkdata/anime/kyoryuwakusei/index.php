...
<head>
  ...
  <title>恐竜惑星 - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">恐竜惑星</h1>
          <h1 class="pagetitle en" lang="en-gb">Dinosaur Planet</h1>
          <h1 class="pagetitle tw" lang="zh-tw">恐竜惑星</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Dinosaur Planet</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">1993</h2>

          <table class="table table-bordered mx-auto anime" summary="恐竜惑星">

            <?php
  $lines = file('../csv/kyoryuwakusei.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){
