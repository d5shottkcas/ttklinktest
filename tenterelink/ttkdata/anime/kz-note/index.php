...
<head>
  ...
  <title>探偵チームKZ事件ノート - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">探偵チームKZ事件ノート</h1>
          <h1 class="pagetitle en" lang="en-gb">Detective Team KZ Case Note</h1>
          <h1 class="pagetitle tw" lang="zh-tw">偵探チームKZ一個案例ノート</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Tantei Team KZ Jiken Note</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <table class="table table-bordered mx-auto anime" summary="探偵チームKZ事件ノート">

            <?php
  $lines = file('../csv/kz-note.csv');
  for($i=0;$i<count($lines);$i++){
