...
<head>
  ...
  <title>アリスSOS - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">アリスSOS</h1>
          <h1 class="pagetitle en" lang="en-gb">Alice SOS</h1>
          <h1 class="pagetitle tw" lang="zh-tw">アリスSOS</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Alice SOS</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">1998</h2>

          <table class="table table-bordered mx-auto anime" summary="アリスSOS">

            <?php
  $lines = file('../csv/arisusos.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){
