...
<head>
  ...
  <title>ズモモとヌペペ - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ズモモとヌペペ</h1>
          <h1 class="pagetitle en" lang="en-gb">dumomo and nupepe</h1>
          <h1 class="pagetitle tw" lang="zh-tw">ズモモとヌペペ</h1>
          <h1 class="pagetitle tl" lang="tl-ph">dumomo and nupepe</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2012</h2>

          <table class="table table-bordered mx-auto anime" summary="ズモモとヌペペ">

            <?php
  $lines = file('../csv/zummo-nupepe.csv');
  for($i=0;$i<count($lines);$i++){
