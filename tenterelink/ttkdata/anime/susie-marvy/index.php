...
<head>
  ...
  <title>スージーちゃんとマービー - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">スージーちゃんとマービー</h1>
          <h1 class="pagetitle en" lang="en-gb">Susie and Marvy</h1>
          <h1 class="pagetitle tw" lang="zh-tw">スージーちゃんとマービー</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Susie and Marvy</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">1999</h2>

          <table class="table table-bordered mx-auto anime" summary="スージーちゃんとマービー">

            <?php
  $lines = file('../csv/susie-marvy.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){
