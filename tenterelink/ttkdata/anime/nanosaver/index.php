...
<head>
  ...
  <title>救命戦士ナノセイバー - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">救命戦士ナノセイバー</h1>
          <h1 class="pagetitle en" lang="en-gb">Nanosaver</h1>
          <h1 class="pagetitle tw" lang="zh-tw">救命戦士ナノセイバー</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Nanosaver</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">1997</h2>

          <table class="table table-bordered mx-auto anime" summary="救命戦士ナノセイバー">

            <?php
  $lines = file('../csv/nanosaver.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){
