...
<head>
  ...
  <title>くつだる。 - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">くつだる。</h1>
          <h1 class="pagetitle en" lang="en-gb">Recent Monster</h1>
          <h1 class="pagetitle tw" lang="zh-tw">くつだる。</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Kutsu Daru</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2014-2015</h2>

          <table class="table table-bordered mx-auto anime" summary="くつだる。">

            <?php
  $lines = file('../csv/kutsudaru.csv');
  for($i=0;$i<count($lines);$i++){
