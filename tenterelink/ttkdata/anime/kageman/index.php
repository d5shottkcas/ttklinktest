...
<head>
  ...
  <title>探偵少年カゲマン - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">探偵少年カゲマン</h1>
          <h1 class="pagetitle en" lang="en-gb">Shadow man</h1>
          <h1 class="pagetitle tw" lang="zh-tw">探偵少年カゲマン</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Shadow man</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2001</h2>

          <table class="table table-bordered mx-auto anime" summary="探偵少年カゲマン">

            <?php
  $lines = file('../csv/kageman.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){
