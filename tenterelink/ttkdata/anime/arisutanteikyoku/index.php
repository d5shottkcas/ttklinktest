...
<head>
  ...
  <title>アリス探偵局 - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">アリス探偵局</h1>
          <h1 class="pagetitle en" lang="en-gb">Alice Detective Office</h1>
          <h1 class="pagetitle tw" lang="zh-tw">アリス探偵局</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Alice Detective Office</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">1995</h2>

          <table class="table table-bordered mx-auto anime" summary="アリス探偵局">

            <?php
  $lines = file('../csv/arisutanteikyoku-1995.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){
  ...
  ?>
          ...
          <h2 class="h2-border">1996</h2>

          <table class="table table-bordered mx-auto anime" summary="アリス探偵局">

            <?php
  $lines = file('../csv/arisutanteikyoku-1996.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){
