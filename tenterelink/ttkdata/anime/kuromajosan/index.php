...
<head>
  ...
  <title>黒魔女さんが通る!! - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">黒魔女さんが通る!!</h1>
          <h1 class="pagetitle en" lang="en-gb">Here Comes the Black Witchi!!</h1>
          <h1 class="pagetitle tw" lang="zh-tw">黑魔女學園</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Kuromajo-san ga Toru!!</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2012-2013</h2>

          <table class="table table-bordered mx-auto anime" summary="黒魔女さんが通る!!">

            <?php
  $lines = file('../csv/kuromajosan.csv');
  for($i=0;$i<count($lines);$i++){
