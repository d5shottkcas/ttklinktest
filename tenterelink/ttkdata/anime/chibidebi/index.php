...
<head>
  ...
  <title>ちび☆デビ! - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ちび☆デビ!</h1>
          <h1 class="pagetitle en" lang="en-gb">Chibi Devi!</h1>
          <h1 class="pagetitle tw" lang="zh-tw">ちび☆デビ!</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Chibi Devi!</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2011-2013</h2>

          <table class="table table-bordered mx-auto anime" summary="ちび☆デビ!">

            <?php
  $lines = file('../csv/chibidebi.csv');
  for($i=0;$i<count($lines);$i++){
