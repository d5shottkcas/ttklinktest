...
<head>
  ...
  <title>ギガントシューターつかさ - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ギガントシューターつかさ</h1>
          <h1 class="pagetitle en" lang="en-gb">Gigant Big-Shot Tsukasa</h1>
          <h1 class="pagetitle tw" lang="zh-tw">ギガントシューターつかさ</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Gigant Shooter Tsukasa</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2014</h2>

          <table class="table table-bordered mx-auto anime" summary="ギガントシューターつかさ">

            <?php
  $lines = file('../csv/gigantshooter.csv');
  for($i=0;$i<count($lines);$i++){
