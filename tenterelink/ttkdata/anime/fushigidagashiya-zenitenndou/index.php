...
<head>
  ...
  <title>ふしぎ駄菓子屋 銭天堂 - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ふしぎ駄菓子屋 銭天堂</h1>
          <h1 class="pagetitle en" lang="en-gb">ふしぎ駄菓子屋 銭天堂</h1>
          <h1 class="pagetitle tw" lang="zh-tw">ふしぎ駄菓子屋 銭天堂</h1>
          <h1 class="pagetitle tl" lang="tl-ph">ふしぎ駄菓子屋 銭天堂</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2020</h2>

          <table class="table table-bordered mx-auto anime" summary="ふしぎ駄菓子屋 銭天堂">

            <?php
  $lines = file('../csv/fushigidagashiya-zenitenndou.csv');
  for($i=0;$i<count($lines);$i++){
