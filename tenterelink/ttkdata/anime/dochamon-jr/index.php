...
<head>
  ...
  <title>どちゃもんじゅにあ - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">どちゃもんじゅにあ</h1>
          <h1 class="pagetitle en" lang="en-gb">Indigenous monster jr.</h1>
          <h1 class="pagetitle tw" lang="zh-tw">土著怪物Jr.</h1>
          <h1 class="pagetitle tl" lang="tl-ph">DoChaMoN Jr.</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2015-2016</h2>

          <table class="table table-bordered mx-auto anime" summary="どちゃもんじゅにあ">

            <?php
  $lines = file('../csv/dochamon-jr.csv');
  for($i=0;$i<count($lines);$i++){
