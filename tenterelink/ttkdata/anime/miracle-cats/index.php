...
<head>
  ...
  <title>おまかせ!みらくるキャット団 - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">おまかせ！みらくるキャット団</h1>
          <h1 class="pagetitle en" lang="en-gb">Omakase! Miracle Cat-dan</h1>
          <h1 class="pagetitle tw" lang="zh-tw">おまかせ！みらくるキャット團</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Omakase! Miracle Cat-dan</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2015</h2>

          <table class="table table-bordered mx-auto anime" summary="おまかせ！みらくるキャット団">

            <?php
  $lines = file('../csv/miracle-cats.csv');
  for($i=0;$i<count($lines);$i++){
