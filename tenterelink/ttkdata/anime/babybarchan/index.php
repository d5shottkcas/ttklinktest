...
<head>
  ...
  <title>ベイベーばあちゃん - 天てれアニメ - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">ベイベーばあちゃん</h1>
          <h1 class="pagetitle en" lang="en-gb">Baby grandma</h1>
          <h1 class="pagetitle tw" lang="zh-tw">ベイベーばあちゃん</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Baby grandma</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-8 order-lg-2">
        ...
        <div class="text-left">
          ...
          <h2 class="h2-border">2002</h2>

          <table class="table table-bordered mx-auto anime" summary="ベイベーばあちゃん">

            <?php
  $lines = file('../csv/babybarchan.csv');
  $count = count($lines);
for($i=0;$i<$count;$i++){
