...
<head>
  ...
  <title>天てれ論 第16回 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれ論</h1>
          <h1 class="pagetitle en" lang="en-gb">Essay on Whiz-kids TV</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれ論</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Teorya ng heaven</h1>
        </header>
    ...
    <!-- /.row -->
        ...
        <h2 class="h2-grey jp" lang="ja-jp">天てれ論　第16回</h2>
        <h2 class="h2-grey en" lang="en-gb">天てれ論　第16回</h2>
        <h2 class="h2-grey tw" lang="zh-tw">天てれ論　第16回</h2>
        <h2 class="h2-grey tl" lang="tl-ph">天てれ論　第16回</h2>
    ...
    <div class="row">
      ...
      <div class="col-lg-3 order-lg-1">
        ...
        <div class="smenu">
          <ul class="smenu">
            <?php
                $lines = file('../csv/comment-list.csv');
                $count = count($lines);
            for($i=0;$i<$count;$i++){
    
                  $csv = explode(',',$lines[$i]);
                  echo '<li class="smenu">'.'<a href="'.$csv[0].'">'.$csv[1].'</a>'.'</li>';
                }
                ?>
          </ul>
        </div>
