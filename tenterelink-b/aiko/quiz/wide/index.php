...
$quiz = 1;
$qfile = '../wide-list/quiz'.$rand[$quiz].'.php';
...
<head>
  ...
  <title>天てれクイズ ワイド編 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれクイズ ワイド編</h1>
          <h1 class="pagetitle en" lang="en-gb">Whiz-Kids TV　Quiz Wide</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれ小測驗 Wide編</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Tentere Pagsusulit Wide</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="controller">
          ...
          <form method="POST" action="./wide-a.php">
          <div class="row">
