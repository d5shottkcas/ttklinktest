...
$quiz = 1;
$qfile = '../lets-list/quiz'.$rand[$quiz].'.php';
...
<head>
  ...
  <title>天てれクイズ Let's編 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれクイズ Let's編</h1>
          <h1 class="pagetitle en" lang="en-gb">Whiz-Kids TV　Quiz Let's</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれ小測驗 Let's編</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Tentere Pagsusulit Let's</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="controller">
          ...
          <form method="POST" action="./lets-a.php">
          <div class="row">
