...
$qfile = '../dai-list/quiz'.$rand[$quiz].'.php';
...
<head>
  ...
  <title>天てれクイズ 大天編 - 天てれリンクプラス</title>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <header>
          <h1 class="pagetitle jp" lang="ja-jp">天てれクイズ 大天編</h1>
          <h1 class="pagetitle en" lang="en-gb">Whiz-Kids TV　Quiz Dai</h1>
          <h1 class="pagetitle tw" lang="zh-tw">天てれ小測驗 大天編</h1>
          <h1 class="pagetitle tl" lang="tl-ph">Tentere Pagsusulit Dai</h1>
        </header>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="controller">
          ...
          <form method="POST" action="./dai-a.php">
          <div class="row">
