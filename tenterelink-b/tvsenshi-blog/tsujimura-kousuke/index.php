...
<head>
  ...
  <title>大天才テレビジョンブログ 辻村晃佑 - 天てれリンクB号館</title>
...
<body>
  ...
  <div class="container">
    ...
    <!-- 投稿日 -->
    <h1 class="mt-4 h2">辻村晃佑 ブログ記事一覧</h1>
    <hr>
      ...
      <?php
            $lines = file('../../tvsenshi-blog/tsujimura-kousuke/csv/tsujimura-kousuke-blog.csv');
            $count = count($lines);
            for($i=0;$i<$count;$i++){
              $csv = explode(',',$lines[$i]);
              echo "<tr>";
