...
<head>
  ...
  <title>大天才テレビジョンブログ 2012 2月25日 - 天てれリンクB号館</title>
...
<body>
  ...
  <div class="container">
    ...
    <!-- 投稿日 -->
    <h1 class="mt-4 h2">大天才テレビジョンブログ 2012 2月25日</h1>
    <hr>
      ...
      <div class="col-lg-8">
        ...
        <div class="card my-4">
          ...
          <h5 class="card-header">
            <?php
            $lines = file('csv/blog20130225-01.csv');
            $count = count($lines);
            $i=0;
              $csv = explode(',',$lines[$i]);
              echo $csv[0];
        ...
        <div class="card my-4">
          ...
          <h5 class="card-header">
            <?php
            $lines = file('csv/blog20130225-02.csv');
            $count = count($lines);
            $i=0;
              $csv = explode(',',$lines[$i]);
              echo $csv[0];
        ...
        <div class="card my-4">
          ...
          <h5 class="card-header">
            <?php
            $lines = file('csv/blog20130225-03.csv');
            $count = count($lines);
            $i=0;
              $csv = explode(',',$lines[$i]);
              echo $csv[0];
        ...
        <div class="card my-4">
          ...
          <h5 class="card-header">
            <?php
            $lines = file('csv/blog20130225-04.csv');
            $count = count($lines);
            $i=0;
              $csv = explode(',',$lines[$i]);
              echo $csv[0];
        ...
        <div class="card my-4">
          ...
          <div class="card-body">
            <table class="table-bordered w-100 text-center">
              <?php
            $lines = file('../calendar2012/calendar201302.csv');
            $count = count($lines);
            $i=0;
              $csv = explode(',',$lines[$i]);
              echo "<tr>";
